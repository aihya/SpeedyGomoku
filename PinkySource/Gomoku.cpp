...
uint64_t Gomoku::evaluate_dir(uint64_t *board, t_coord piece_coord, t_piece piece, t_coord direction)
{
    ...
    {
        current_pattern = 0;
        pattern_position = current_position;
        for (int j = 0; j < 5; j++)
        {
            current_pattern <<= 2;
